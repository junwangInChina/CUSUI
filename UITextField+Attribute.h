...
/**
 *  UITextField的扩展
 *  扩展了TextField的一些属性，行间距、段落间距、字符间距、下划线、删除线。。。等扩展
 *  为了避免越界，只能在TextField先设置好Text后，再设置以下属性，才有作用
 *  否则不起作用
...
/**
 *  UITextField类别，文案展示扩展方法。设置行间距
 *  PS:前提条件是明确知道当前TextField的Text
 *
...
/**
 *  UITextField类别，文案展示扩展方法。设置整体文案缩进
 *  PS:前提条件是明确知道当前TextField的Text
 *
...
/**
 *  UITextField类别，文案展示扩展方法。设置段尾缩进，实际效果时设置整个文案显示的宽度
 *  PS:前提条件是明确知道当前TextField的Text
 *
...
/**
 *  UITextField类别，文案展示扩展方法。设置多行高(可变行高,乘因数。暂时还不懂与设置行高有什么区别)
 *  PS:前提条件是明确知道当前TextField的Text
 *
...
/**
 *  UITextField类别，文案展示扩展方法。设置段首空间(感觉应该是每一段的首行缩进)
 *  PS:前提条件是明确知道当前TextField的Text
 *
...
/**
 *  UITextField类别，文案展示扩展方法。设置文案书写方向
 *  PS:前提条件是明确知道当前TextField的Text
 *
...
/**
 *  UITextField类别，文案展示扩展方法。添加下划线，默认全部文案添加
 *  PS:前提条件是明确知道当前TextField的Text
 *
 *  @param  无
 *  @return 无
...
/**
 *  UITextField类别，文案展示扩展方法。添加下划线，根据传入的范围添加
 *  PS:前提条件是明确知道当前TextField的Text
 *
...
/**
 *  UITextField类别，文案展示扩展方法。添加删除线，默认全部文案添加
 *  PS:前提条件是明确知道当前TextField的Text
 *
 *  @param  无
 *  @return 无
...
/**
 *  UITextField类别，文案展示扩展方法。添加删除线，根据传入的范围添加
 *  PS:前提条件是明确知道当前TextField的Text
 *
...
/**
 *  UITextField类别，文案展示扩展方法。修改字体颜色，根据传入的范围添加（用于不同颜色文案展示在同一TextField上）
 *  PS:前提条件是明确知道当前TextField的Text
 *
 *  @param  color:需要改变的颜色
...
/**
 *  UITextField类别，文案展示扩展方法。修改背景颜色，根据传入的范围添加（用于不同颜色文案展示在同一TextField上）
 *  PS:前提条件是明确知道当前TextField的Text
 *
 *  @param  color:需要改变的颜色
...
/**
 *  UITextField类别，文案展示扩展方法。修改字符字体，根据传入的范围修改。
 *  PS:前提条件是明确知道当前TextField的Text
 *
 *  @param  font :需要改变的字体
...
/**
 *  UITextField类别，文案展示扩展方法。修改字符间距，根据传入的范围修改。
 *  PS:前提条件是明确知道当前TextField的Text
 *
 *  @param  space:需要改变的间距
 *  @param  range:需要修改间距的范围
...
/**
 *  UITextField类别，文案展示扩展方法。修改字体为空心，默认修改全部文案为空心字。
 *  PS:前提条件是明确知道当前TextField的Text
 *
 *  @param  space:需要改变的程度
 *  @return 无
...
/**
 *  UITextField类别，文案展示扩展方法。修改字体为空心，同时修改颜色。
 *  PS:前提条件是明确知道当前TextField的Text
 *
 *  @param  space:需要改变的程度
 *  @param  color:要修改的颜色
...
/**
 *  UITextField类别，文案展示扩展方法。修改字体为空心，根据传入的范围修改。
 *  PS:前提条件是明确知道当前TextField的Text
 *
 *  @param  space:需要改变的程度
...
/**
 *  UITextField类别，文案展示扩展方法。修改字体为空心，同时修改颜色，根据传入的范围修改。
 *  PS:前提条件是明确知道当前TextField的Text
 *
 *  @param  space:需要改变的程度
 *  @param  range:需要修改空心的范围
